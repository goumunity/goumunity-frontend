...
function NavBar() {
    ...
    return (
        <nav className={`flex flex-col fixed w-72 h-screen text-2xl font-daeam p-5 }`}
             style={{backgroundSize: 'cover', backgroundImage: `url(${NavBarBackGround})`}}>
            {
                    ...
                    <>
                        <div id="NavProfile"
                            ...
                            <div class="w-full flex flex-row justify-around mt-5 p-1">
                                ...
                                <div
                                    className="text-xl hover:text-gray-500 cursor-pointer overflow-x-hidden flex items-center">{currentUser.nickname}님
                                    환영합니다!
                                </div>
