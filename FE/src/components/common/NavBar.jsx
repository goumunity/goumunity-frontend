...
function NavBar() {
  ...
  return (
    <nav
      className={`flex flex-col fixed w-72 h-screen text-2xl font-daeam p-5 }`}
      style={{
    ...
    >
      {targetUrl !== '/profile' || targetUrl !== '/profile/detail' ? (
        <>
          ...
          >
            <img
              className='w-48 rounded-full border-black border-2'
              src={currentUser.imgSrc}
            />
            <div className='w-full flex flex-row justify-around mt-5 p-1'>
              <div className='text-xl hover:text-gray-500 cursor-pointer overflow-x-hidden flex items-center'>
