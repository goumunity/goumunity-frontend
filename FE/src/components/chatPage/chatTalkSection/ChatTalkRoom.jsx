            ...
            <div className={'border'}>
                {profileImage ?
                    <div className={'w-20 rounded p-1  flex'}>
                        ...
                        <i className="ml-1 fa-regular fa-circle-xmark hover:cursor-pointer hover:text-red-500"
                ...
                <div className='flex border justify-between items-center pb-0 grow-0 '>
                    ...
                    <div className={'flex-grow flex justify-center h-full'}>
                        <i onClick={() => fileUploader.current.click()}
                           className='fa-solid fa-circle-plus fa-xl hover:cursor-pointer '></i>
                    </div>
